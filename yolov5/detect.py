            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        cv2.polylines(im0, [coordinates], True, 255, 1)
                        text_location = (int(xc-10),int(yc-210))
                        box_height_mm = (box_height * 200) / img_height
                        cv2.putText(im0, f'{round(box_height_mm, 2)}', text_location, cv2.FONT_HERSHEY_SIMPLEX, 0.5, 255, 1)
                        #========
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        label = None if hide_labels else (f't_{names[c].split("_")[1]}' if hide_conf else f't_{names[c].split("_")[1]} {conf:.2f}')
